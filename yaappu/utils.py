...
SANDHAPAA_DICT1 = [
    {'VN':'தா','YN':'னா','MN':'னா','VK':'த','YK':'ன','MK':'ன','VO':'த்','YO':'த்','MO':'ந்',},
    {'KVK':'தன','KVN':'தனா','NVK':'தான','NVN':'தானா',
     'KYK':'தன','KYN':'தனா','NYK':'தான','NYN':'தானா',
     'KMK':'தன','KMN':'தனா','NMK':'தான','NMN':'தானா'},
    {'KVOVK':'தத்த','KMOMK':'தன்ன','KMOYK':'தன்ன','KYOVK':'தய்ய','KYOYK':'தய்ய','KMOVK':'தந்த',
     'KVOVN':'தத்தா','KMOMN':'தன்னா','KMOYN':'தன்னா','KYOVN':'தய்யா','KYOYN':'தய்யா',
     'NVOVK':'தாத்த','NVOVN':'தாத்தா','KMOVN':'தந்தா','NMOVK':'தாந்த','NMOVN':'தாந்தா',
     }
]
VANNAPAA_DICT = [
...
{
 'UKVOVKVK':'தந்தன','UKYOVKVK':'தந்தன','UKMOVKVK':'தந்தன','UKVOVNVK':'தந்தான','UKYOVNVK':'தந்தான','UKMOVNVK':'தந்தான',
 'UKVOVKYK':'தந்தன','UKYOVKYK':'தந்தன','UKMOVKYK':'தந்தன','UKVOVNYK':'தந்தான','UKYOVNYK':'தந்தான','UKMOVNYK':'தந்தான',
 'UKVOVKMK':'தந்தன','UKYOVKMK':'தந்தன','UKMOVKMK':'தந்தன','UKVOVNMK':'தந்தான','UKYOVNMK':'தந்தான','UKMOVNMK':'தந்தான',
 'VKVOVKVK':'தந்தன','VKYOVKVK':'தந்தன','VKMOVKVK':'தந்தன','VKVOVNVK':'தந்தான','VKYOVNVK':'தந்தான','VKMOVNVK':'தந்தான',
 'VKVOVKYK':'தத்தன','VKYOVKYK':'தந்தன','VKMOVKYK':'தந்தன','VKVOVNYK':'தந்தான','VKYOVNYK':'தந்தான','VKMOVNYK':'தந்தான',
 'VKVOVKMK':'தந்தன','VKYOVKMK':'தந்தன','VKMOVKMK':'தந்தன','VKVOVNMK':'தந்தான','VKYOVNMK':'தந்தான','UKMOVNMK':'தந்தான',
 'YKVOVKVK':'தந்தன','YKYOVKVK':'தந்தன','YKMOVKVK':'தந்தன','YKVOVNVK':'தந்தான','YKYOVNVK':'தந்தான','YKMOVNVK':'தந்தான',
 'YKVOVKYK':'தந்தன','YKYOVKYK':'தந்தன','YKMOVKYK':'தந்தன','YKVOVNYK':'தந்தான','YKYOVNYK':'தந்தான','YKMOVNYK':'தந்தான',
 'YKVOVKMK':'தந்தன','YKYOVKMK':'தந்தன','YKMOVKMK':'தந்தன','YKVOVNMK':'தந்தான','YKYOVNMK':'தந்தான','YKMOVNMK':'தந்தான',
},
...
VANNAPAA_DICT1 = {'தத்த':['KVOVK','KVOVKVO','KVOVKYO','KVOVKMO','KYOVOVK','KYOVOVKVO','KYOVOVKYO','KYOVOVKMO','KMOVOVK','KMOVOVKVO','KMOVOVKYO','KMOVOVKMO'],
                  'தத்தா':['KVOVN','KVOVNVO','KVOVNYO','KVOVNMO','KYOVOVN','KYOVOVNVO','KYOVOVNYO','KYOVOVNMO','KMOVOVN','KMOVOVNVO','KMOVOVNYO','KMOVOVNMO'],
                  'தாத்த':['NVOVK','NVOVKVO','NVOVKYO','NVOVKMO','NYOVOVK','NYOVOVKVO','NYOVOVKYO','NYOVOVKMO','NMOVOVK','NMOVOVKVO','NMOVOVKYO','NMOVOVKMO'],
                  'தாத்தா':['NVOVN','NVOVNVO','NVOVNYO','NVOVNMO','NYOVOVN','NYOVOVNVO','NYOVOVNYO','NYOVOVNMO','NMOVOVN','NMOVOVNVO','NMOVOVKYO','NMOVOVKMO'],
                  'தந்த':['KMOVK','KMOVKVO','KMOVKYO','KMOVKMO','KYOMOVK','KYOMOVKVO','KYOMOVKYO','KYOMOVKMO','KMOMOVK','KMOMOVKVO','KMOMOVKYO','KMOMOVKMO'],
                  'தந்தா':['KMOVN','KMOVNVO','KMOVNYO','KMOVNMO','KYOMOVN','KYOMOVNVO','KYOMOVNYO','KYOMOVNMO','KMOMOVN','KMOMOVNVO','KMOMOVNYO','KMOMOVNMO'],
                  'தாந்த':['NMOVK','NMOVKVO','NMOVKYO','NMOVKMO','NYOMOVK','NYOMOVKVO','NYOMOVKYO','NYOMOVKMO','NMOMOVK','NMOMOVKVO','NMOMOVKYO','NMOMOVKMO'],
                  'தாந்தா':['NMOVN','NMOVNVO','NMOVNYO','NMOVNMO','NYOMOVN','NYOMOVNVO','NYOMOVNYO','NYOMOVNMO','NMOMOVN','NMOMOVNVO','NMOMOVKYO','NMOMOVKMO'],
                  'தன்ன':['KMOMK','KMOMKMO','KMOMKYO','KMOYK','KMOYKMO','KMOYKYO'],
                  'தன்னா':['KMOMN','KMOMNMO','KMOMNYO','KMOYN','KMOYNMO','KMOYNYO'],
                  'தய்ய':['KYOMK','KYOMKMO','KYOMKYO','KYOYK','KYOYKMO','KYOYKYO'],
                  'தய்யா':['KYOMN','KYOMNMO','KYOMNYO','KYOYN','KYOYNMO','KYOYNYO'],
                  'தன':['KVKVO','KVKYO','KVKMO','KVK','KYKVO','KYKYO','KYKMO','KYK','KMKVO','KMKYO','KMKMO','KMK'],
                  'தனா':['KVNVO','KVNYO','KVNMO','KVN','KYNVO','KYNYO','KYNMO','KYN','KMNVO','KMNYO','KMNMO','KMN'],
                  'தான':['NVKVO','NVKYO','NVKMO','NVK','NYKVO','NYKYO','NYKMO','NYK','NMKVO','NMKYO','NMKMO','NMK'],
                  'தானா':['NVNVO','NVNYO','NVNMO','NVN','NYNVO','NYNYO','NYNMO','NYN','NMNVO','NMNYO','NMNMO','NMN'],
                 }
VANNAPAA_DICT2 = [
                   {'VK':'ன','YK':'ன','MK':'ன',},#'VN':'னா','YN':'னா','MN':'னா','VO':'த்','YO':'த்','MO':'ந்',},
                    {'KVK': 'தன', 'KYK': 'தன', 'KMK': 'தன', 'KVN': 'தனா', 'KYN': 'தனா', 'KMN': 'தனா', 
                     'NVK': 'தான', 'NYK': 'தான', 'NMK': 'தான', 'NVN': 'தானா', 'NYN': 'தானா', 'NMN': 'தானா'},
                    {'KVOVK': 'தத்த', 'KVOVN': 'தத்தா', 'NVOVK': 'தாத்த', 'NVOVN': 'தாத்தா', 
                     'KMOVK': 'தந்த', 'KMOVN': 'தந்தா', 'NMOVK': 'தாந்த', 'NMOVN': 'தாந்தா', 
                     'KMOMK': 'தன்ன', 'KMOYK': 'தன்ன', 'KMOMN': 'தன்னா', 'KMOYN': 'தன்னா', 
                     'KYOMK': 'தய்ய', 'KYOYK': 'தய்ய', 'KYOMN': 'தய்யா', 'KYOYN': 'தய்யா', 
                     'KVKVO': 'தன', 'KVKYO': 'தன', 'KVKMO': 'தன', 'KYKVO': 'தன', 'KYKYO': 'தன', 'KYKMO': 'தன', 'KMKVO': 'தன', 'KMKYO': 'தன', 'KMKMO': 'தன', 
                     'KVNVO': 'தனா', 'KVNYO': 'தனா', 'KVNMO': 'தனா', 'KYNVO': 'தனா', 'KYNYO': 'தனா', 'KYNMO': 'தனா', 'KMNVO': 'தனா', 'KMNYO': 'தனா', 'KMNMO': 'தனா', 
                     'NVKVO': 'தான', 'NVKYO': 'தான', 'NVKMO': 'தான', 'NYKVO': 'தான', 'NYKYO': 'தான', 'NYKMO': 'தான', 'NMKVO': 'தான', 'NMKYO': 'தான', 'NMKMO': 'தான', 
                     'NVNVO': 'தானா', 'NVNYO': 'தானா', 'NVNMO': 'தானா', 'NYNVO': 'தானா', 'NYNYO': 'தானா', 'NYNMO': 'தானா', 'NMNVO': 'தானா', 'NMNYO': 'தானா', 'NMNMO': 'தானா'}, 
                    {'VKVOVK':'தன','VKVOYK':'தன','VKVOMK':'தன','YKVOVK':'தன','YKVOYK':'தன','YKVOMK':'தன','MKVOVK':'தன','MKVOYK':'தன','MKVOMK':'தன',},
                    {'VKYOVK':'தன','VKYOYK':'தன','VKYOMK':'தன','YKYOVK':'தன','YKYOYK':'தன','YKYOMK':'தன','MKYOVK':'தன','MKYOYK':'தன','MKYOMK':'தன',},
                    {'VKMOVK':'தன','VKMOYK':'தன','VKMOMK':'தன','YKMOVK':'தன','YKMOYK':'தன','YKMOMK':'தன','MKMOVK':'தன','MKMOYK':'தன','MKMOMK':'தன',},
                    {'VNVOVK':'தான','VNVOYK':'தான','VNVOMK':'தான','YNVOVK':'தான','YNVOYK':'தான','YNVOMK':'தான','MNVOVK':'தான','MNVOYK':'தான','MNVOMK':'தான',},
                    {'VNYOVK':'தான','VNYOYK':'தான','VNYOMK':'தான','YNYOVK':'தான','YNYOYK':'தான','YNYOMK':'தான','MNYOVK':'தான','MNYOYK':'தான','MNYOMK':'தான',},
                    {'VNMOVK':'தான','VNMOYK':'தான','VNMOMK':'தான','YNMOVK':'தான','YNMOYK':'தான','YNMOMK':'தான','MNMOVK':'தான','MNMOYK':'தான','MNMOMK':'தான',},
                    {'VKVOVN':'தனா','VKVOYN':'தனா','VKVOMN':'தனா','YKVOVN':'தனா','YKVOYN':'தனா','YKVOMN':'தனா','MKVOVN':'தனா','MKVOYN':'தனா','MKVOMN':'தனா',},
                    {'VKYOVN':'தனா','VKYOYN':'தனா','VKYOMN':'தனா','YKYOVN':'தனா','YKYOYN':'தனா','YKYOMN':'தனா','MKYOVN':'தனா','MKYOYN':'தனா','MKYOMN':'தனா',},
                    {'VKMOVN':'தனா','VKMOYN':'தனா','VKMOMN':'தனா','YKMOVN':'தனா','YKMOYN':'தனா','YKMOMN':'தனா','MKMOVN':'தனா','MKMOYN':'தனா','MKMOMN':'தனா',},
                    {'VNVOVN':'தானா','VNVOYN':'தானா','VNVOMN':'தானா','YNVOVN':'தானா','YNVOYN':'தானா','YNVOMN':'தானா','MNVOVN':'தானா','MNVOYN':'தானா','MNVOMN':'தானா',},
                    {'VNYOVN':'தானா','VNYOYN':'தானா','VNYOMN':'தானா','YNYOVN':'தானா','YNYOYN':'தானா','YNYOMN':'தானா','MNYOVN':'தானா','MNYOYN':'தானா','MNYOMN':'தானா',},
                    {'VNMOVN':'தானா','VNMOYN':'தானா','VNMOMN':'தானா','YNMOVN':'தானா','YNMOYN':'தானா','YNMOMN':'தானா','MNMOVN':'தானா','MNMOYN':'தானா','MNMOMN':'தானா',},
                   {'KVOVKVO': 'தத்த', 'KVOVKYO': 'தத்த', 'KVOVKMO': 'தத்த', 'KYOVOVK': 'தத்த', 'KMOVOVK': 'தத்த', 
                    'KVOVNVO': 'தத்தா', 'KVOVNYO': 'தத்தா', 'KVOVNMO': 'தத்தா', 'KYOVOVN': 'தத்தா', 'KMOVOVN': 'தத்தா', 
                    'NVOVKVO': 'தாத்த', 'NVOVKYO': 'தாத்த', 'NVOVKMO': 'தாத்த', 'NYOVOVK': 'தாத்த', 'NMOVOVK': 'தாத்த', 
                    'NVOVNVO': 'தாத்தா', 'NVOVNYO': 'தாத்தா', 'NVOVNMO': 'தாத்தா', 'NYOVOVN': 'தாத்தா', 'NMOVOVN': 'தாத்தா', 
                    'KMOVKVO': 'தந்த', 'KMOVKYO': 'தந்த', 'KMOVKMO': 'தந்த', 'KYOMOVK': 'தந்த', 'KMOMOVK': 'தந்த', 
                    'KMOVNVO': 'தந்தா', 'KMOVNYO': 'தந்தா', 'KMOVNMO': 'தந்தா', 'KYOMOVN': 'தந்தா', 'KMOMOVN': 'தந்தா', 
                    'NMOVKVO': 'தாந்த', 'NMOVKYO': 'தாந்த', 'NMOVKMO': 'தாந்த', 'NYOMOVK': 'தாந்த', 'NMOMOVK': 'தாந்த', 
                    'NMOVNVO': 'தாந்தா', 'NMOVNYO': 'தாந்தா', 'NMOVNMO': 'தாந்தா', 'NYOMOVN': 'தாந்தா', 'NMOMOVN': 'தாந்தா', 
                    'KMOMKMO': 'தன்ன', 'KMOMKYO': 'தன்ன', 'KMOYKMO': 'தன்ன', 'KMOYKYO': 'தன்ன', 
                    'KMOMNMO': 'தன்னா', 'KMOMNYO': 'தன்னா', 'KMOYNMO': 'தன்னா', 'KMOYNYO': 'தன்னா', 
                    'KYOMKMO': 'தய்ய', 'KYOMKYO': 'தய்ய', 'KYOYKMO': 'தய்ய', 'KYOYKYO': 'தய்ய', 
                    'KYOMNMO': 'தய்யா', 'KYOMNYO': 'தய்யா', 'KYOYNMO': 'தய்யா', 'KYOYNYO': 'தய்யா',},
                    {'KYOVOVKVO': 'தத்த', 'KYOVOVKYO': 'தத்த', 'KYOVOVKMO': 'தத்த', 'KMOVOVKVO': 'தத்த', 'KMOVOVKYO': 'தத்த', 'KMOVOVKMO': 'தத்த', 
                   'KYOVOVNVO': 'தத்தா', 'KYOVOVNYO': 'தத்தா', 'KYOVOVNMO': 'தத்தா', 'KMOVOVNVO': 'தத்தா', 'KMOVOVNYO': 'தத்தா', 'KMOVOVNMO': 'தத்தா', 
                   'NYOVOVKVO': 'தாத்த', 'NYOVOVKYO': 'தாத்த', 'NYOVOVKMO': 'தாத்த', 'NMOVOVKVO': 'தாத்த', 
                   'NMOVOVKYO': 'தாத்தா', 'NMOVOVKMO': 'தாத்தா', 'NYOVOVNVO': 'தாத்தா', 'NYOVOVNYO': 'தாத்தா', 'NYOVOVNMO': 'தாத்தா', 'NMOVOVNVO': 'தாத்தா', 
                   'KYOMOVKVO': 'தந்த', 'KYOMOVKYO': 'தந்த', 'KYOMOVKMO': 'தந்த', 'KMOMOVKVO': 'தந்த', 'KMOMOVKYO': 'தந்த', 'KMOMOVKMO': 'தந்த', 
                   'KYOMOVNVO': 'தந்தா', 'KYOMOVNYO': 'தந்தா', 'KYOMOVNMO': 'தந்தா', 'KMOMOVNVO': 'தந்தா', 'KMOMOVNYO': 'தந்தா', 'KMOMOVNMO': 'தந்தா', 
                   'NYOMOVKVO': 'தாந்த', 'NYOMOVKYO': 'தாந்த', 'NYOMOVKMO': 'தாந்த', 'NMOMOVKVO': 'தாந்த', 
                   'NMOMOVKYO': 'தாந்தா', 'NMOMOVKMO': 'தாந்தா', 'NYOMOVNVO': 'தாந்தா', 'NYOMOVNYO': 'தாந்தா', 'NYOMOVNMO': 'தாந்தா', 'NMOMOVNVO': 'தாந்தா'},                 ]                
